...
const contentData = {
  'tab-1': { fixed: img1, slides: [lk1, lk2, lk3, lk4, lk5, lk6, lk7, lk8, lk9] },
  'tab-2': { fixed: img2, slides: [lkb1, lkb2, lkb3, lkb4, lkb5, lkb6, lkb7, lkb8] },
  ...
  return (
    ...
    style={{
      ...
      <div className="text-center font-content text-white">
        <p>
          Nét đẹp tinh tế của kiến trúc tân cổ điển Châu Âu với điểm nhấn mái Mansard biểu trưng cho sự giao hòa Đông - Tây được tái hiện hoàn mỹ qua những dãy phố mang vẻ đẹp cân bằng giữa hoài cổ và hiện đại.
        </p>
      </div>
        <br />
